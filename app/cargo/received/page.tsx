...
import { Truck, Package, Search, Plus, Edit, Trash2, ChevronLeft, ChevronRight, Home } from 'lucide-react';
...
const CargoReceived = () => {
  const [cargoData, setCargoData] = useState<CargoItem[]>([
    { id: 1, goodsName: 'Medical Equipment', transport: 'Road', date: '2024-03-15', receivedBy: 'John Doe', weight: '150', cargoSN: 'CRG001' },
    { id: 2, goodsName: 'Spare Parts', transport: 'Air', date: '2024-03-14', receivedBy: 'Jane Smith', weight: '45', cargoSN: 'CRG002' },
  ]);
  ...
  const handleAdd = () => {
    if (!formData.goodsName || !formData.date || !formData.receivedBy || !formData.weight || !formData.cargoSN) {
    ...
    setFormData({ goodsName: '', transport: 'Road', date: new Date().toISOString().split('T')[0], receivedBy: '', weight: '', cargoSN: '' });
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <h1 className="text-2xl font-bold text-white">Cargo Received</h1>
            </div>
        ...
        <div className="mb-6 max-w-2xl mx-auto">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-white shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
          </div>
        </div>

        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">Add Received Cargo</h2>
            ...
            <table className="w-full">
              <thead className="bg-green-100 text-green-800">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-sm uppercase tracking-wider">Received By</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {paginatedData.map((item, index) => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">{item.receivedBy}</td>
      ...
      <Link
        href="/cargo"
        className="fixed bottom-6 right-6 flex items-center justify-center w-14 h-14 rounded-full bg-green-600 hover:bg-green-700 text-white shadow-lg"
      >
